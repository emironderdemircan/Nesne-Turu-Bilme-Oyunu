...
{
    class MetalKutusu : IAtikKutusu //IAtikKutusu interface'si tanımlanıyor.
    {
        public int BosaltmaPuani => 800; //Kutu boşaltılınca alınacak puan belirleniyor.

        public int Kapasite { get => 2300; set => throw new NotImplementedException(); } //Kutunun kapasitesi belirleniyor.
        ...
        public bool Ekle(IAtik atik)
        {
            ...
            if (string.Compare(atik.AtikTipi, "KolaKutusu") == 0 || string.Compare(atik.AtikTipi, "SalcaKutusu") == 0)
            {
