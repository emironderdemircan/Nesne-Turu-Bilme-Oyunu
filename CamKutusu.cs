...
{
    class CamKutusu : IAtikKutusu //IAtikKutusu interface'si tanımlanıyor.
    {
        public int BosaltmaPuani => 600; //Kutu boşaltılınca alınacak puan belirleniyor.

        public int Kapasite { get => 2200; set => throw new NotImplementedException(); } //Kutunun kapasitesi belirleniyor.
        ...
        public bool Ekle(IAtik atik)
        {
            ...
            if (string.Compare(atik.AtikTipi, "CamSise") == 0 || string.Compare(atik.AtikTipi, "Bardak") == 0)
            {
